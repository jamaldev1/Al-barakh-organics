        ...
        <div>
          ...
          <div className="mt-6 flex gap-3">
            {[
              ...
              <a
                key={label}
                href={label === 'WhatsApp' ? 'https://wa.me/923000000000' : '#'}
                target={label === 'WhatsApp' ? '_blank' : undefined}
                rel={label === 'WhatsApp' ? 'noopener noreferrer' : undefined}
                className="w-9 h-9 rounded-md bg-gold-400 flex items-center justify-center text-brand-900 hover:bg-gold-300 transition"
                aria-label={label}
              >
